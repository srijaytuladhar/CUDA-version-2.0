 ...
 * 
 * To Compile:
 * nvcc -o cuda_password_2_initials_2_digits cuda_password_2_initials_2_digits.cu
 * 
 * 
 * To Run:
 * ./cuda_password_2_initials_2_digits
 * 
 * 
 *********************************************************/
...
__device__ int password_match_checker(char *password_trial) {
    ...
    char assigned_password_1[] = "BV78";      // 1 of 4 passwords
    char assigned_password_2[] = "ES21";      // 2 of 4 passwords
    char assigned_password_3[] = "HR23";      // 3 of 4 passwords
    char assigned_password_4[] = "RB96";      // 4 of 4 passwords
